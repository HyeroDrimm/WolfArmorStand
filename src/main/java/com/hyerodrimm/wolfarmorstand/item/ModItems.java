package com.hyerodrimm.wolfarmorstand.item;

import com.hyerodrimm.wolfarmorstand.WolfArmorStandMod;
import com.hyerodrimm.wolfarmorstand.WolfArmorStandMod;
import com.hyerodrimm.wolfarmorstand.item.custom.WolfArmorStandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM, Identifier.of(WolfArmorStandMod.MOD_ID, name), item);
    }
