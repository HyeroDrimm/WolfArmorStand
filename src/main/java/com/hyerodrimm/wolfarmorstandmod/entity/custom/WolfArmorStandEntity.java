package com.hyerodrimm.wolfarmorstandmod.entity.custom;
...
/*    public WolfArmorStandEntity(World world, double x, double y, double z) {
        this((EntityType<? extends WolfArmorStandEntity>) ModEntities.WOLF_ARMOR_STAND, world);
